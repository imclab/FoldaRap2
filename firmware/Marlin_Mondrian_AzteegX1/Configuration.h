...
#define STRING_CONFIG_H_AUTHOR "(EmmanuelG, FoldaRap2 #000)" //Who made the changes.
...
#define HOMING_FEEDRATE {30*60, 30*60, 20*60, 0}  // set the homing speeds (mm/min) // 5*60

// default settings 

#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,140}  // default steps per unit for ultimaker // 4000
#define DEFAULT_MAX_FEEDRATE          {500, 500, 3, 50}    // (mm/sec)    // 5
#define DEFAULT_MAX_ACCELERATION      {9000,9000,50,10200}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot. // 100
